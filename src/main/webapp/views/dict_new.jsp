...
<div ng-controller="IndexController">
    <div style="position: relative; top: 20px;"  ng-find="../dict/getDictInfo|dictInfo|id=" >
         <input type="hidden" id="dictionaryId" value="${dictId}">
         <input type="hidden" id="dcType" value="${type}">
         <table class="table_block">
            ...
            <tr>
                ...
                <td> <button class="baocun" type="button" ng-click="getCode();">获取</button></td>
            </tr>
            ...
            <tr>
                  <td></td>
                 <td> <button class="baocun right" type="button" ng-click="saveNewDict();">保存</button></td>
            </tr>
        </table>
    </div>
    <div class="clear"></div>
